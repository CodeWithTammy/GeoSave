...
import com.example.geosaveapp.StartingScreens.SaveState;
...
//        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,WindowManager.LayoutParams.FLAG_FULLSCREEN);
        ...
        if (saveState.getState() == 1){
            startActivity(new Intent(BoardingScreen.this,GetStarted.class));
            finish();
        }
    ...
    private void dotsFunction(int pos) {
        ...
        if (dots.length > 0){
            dots[pos].setTextColor(getColor(R.color.darkblue));   //selected dot color
